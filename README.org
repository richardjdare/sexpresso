 ...
 * The parser records where in the original string each sexp came from. This is stored in sexpresso::Sexp.position. Position has no meaning in Sexp's that were not created by the parser.
